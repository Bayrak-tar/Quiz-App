...
class Seviye1Sayfasi extends StatelessWidget {
  const Seviye1Sayfasi({Key? key}) : super(key: key);
...
class Seviye1Icerik extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<Map<String, dynamic>>>(
      key: UniqueKey(), // Yeni bir key ekleniyor
      future: _getAdimList(),
